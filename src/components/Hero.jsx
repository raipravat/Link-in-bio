  ...
  useEffect(() => {
    const type = () => {
      if (!isDeletingRef.current && indexRef.current < name.length) {
        ...
        indexRef.current++;
        document.getElementById("typing-text").textContent = typedTextRef.current;
        setTimeout(type, 300);
        ...
        <div className="hero-grid">
          ...
          <div className="hero-content">
            <div className="hero-text-wrapper">
              ...
              <h2 className="subtitle fade-in delay-1">I Craft Digital Experiences</h2>
            ...
            <div className="social-icons fade-in delay-4">
              <a href="https://github.com/raipravat" className="social-icon" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <FontAwesomeIcon icon={faGithub} />
              </a>
              <a href="https://x.com/mr_raipravat" className="social-icon" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <FontAwesomeIcon icon={faTwitter} />
              </a>
              <a href="https://t.me/raipravat101" className="social-icon" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
                <FontAwesomeIcon icon={faTelegram} />
              </a>
              <a href="https://wa.me/9779842485969" className="social-icon" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
          ...
          <div className="hero-preview">
            <div className="profile-container">
              <div className="profile-frame slide-in-right delay-3">
                <img src="images/Hero.png" alt="Hero" className="profile-pic" loading="lazy" />
